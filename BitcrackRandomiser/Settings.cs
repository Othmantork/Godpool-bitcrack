...
namespace BitcrackRandomiser
{
    internal class Settings
    {
        ...
        /// <returns></returns>
        public static Settings GetSettings(string[] args, string RemoteURL = "")
        {
            ...
            {
                // From remote
                Lines = Requests.GetRemoteSettings(RemoteURL).Result.Split(Environment.NewLine);
            }
